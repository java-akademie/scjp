...
public class Test2_TexteFindenErsetzen
{
	...
	public static void main(String[] args) throws FileNotFoundException
	{
		...
		replaceAll(
				"diesen scheiss will ich nicht hoeren, leck mich, fuck you",
				"scheiss|fuck|leck mich", "pieps");
		replaceAll("du kannst mich mal am arsch lecken",
				"arsch|fuck|leck mich", "pieps");
	...
	private static void replaceAll(String input, String regex,
			String replacement)
	{
		String ueb = String.format("replaceAll: (%s), text=%s", regex,
				input);
	...
	{
		String ueb = String.format("findAll: (%s), text=%s", regex,
				input);
	...
	{
		String ueb = String.format("Find in Line: (%s), text=%s",
				regex, text);
